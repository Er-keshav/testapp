...
export const Breadcrum = () => {
  ...
  <ol className="breadcrumb" style={{marginBottom: 0}}>
    <li className="breadcrumb-item"><a href="#" style={{textDecoration: 'none', color: "#636363",fontWeight: 600}}>Medical Darpan</a></li>
    <li className="breadcrumb-item"><a href="#" style={{textDecoration: 'none', color: "#636363",fontWeight: 600}}>Search</a></li>
